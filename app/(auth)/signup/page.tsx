...
import { Loader2, Sparkles, ArrowRight, ArrowLeft, Mail } from "lucide-react";
      ...
      <div className="w-full max-w-[420px] rounded-3xl border border-zinc-800 bg-zinc-900/10 p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden">
        <div className="flex flex-col gap-2 text-center mb-8">
          ...
          <p className="text-xs text-zinc-400">
            {isOtpSent ? "Enter the verification code sent to your inbox" : "Sign up using a passwordless one-time verification code"}
          </p>
        </div>
