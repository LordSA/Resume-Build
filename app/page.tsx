...
import { Layout, Award, Zap, ArrowRight } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans flex flex-col selection:bg-blue-600/30 relative max-w-full">
