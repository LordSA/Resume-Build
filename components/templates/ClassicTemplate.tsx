...
export default function ClassicTemplate({ data, theme }: TemplateProps) {
  ...
  const activeFont = theme.customFontName || fontFamily || "Merriweather";
  const fontImport = theme.customFontName && theme.customFontUrl
    ...
    : `@import url('https://fonts.googleapis.com/css2?family=${activeFont.replace(/\s+/g, "+")}:wght@300;400;750;900&display=swap');`;
